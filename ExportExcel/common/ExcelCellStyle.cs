...
namespace ExportExcel.common
{
    public class ExcelCellStyle
    {
        ...
        public ICellStyle styleLeft { get; set; }
        public ICellStyle style4LemonChiffon { get; set; }
        public ICellStyle style4CornflowerBlue { get; set; }
        public ICellStyle style4LightGreen { get; set; }
        public ICellStyle style4Lime { get; set; }
        public ICellStyle cellStyleDate { get; set; }
        public ICellStyle cellStyleSmallDate { get; set; }
        public ICellStyle cellStyleNumber4LemonChiffon { get; set; }
        public ICellStyle cellStyleNumber4CornflowerBlue { get; set; }
        public ICellStyle cellStyleNumber4LightGreen { get; set; }
        public ICellStyle cellStyleNumber4Lime { get; set; }
        public ICellStyle cellStyleNumber { get; set; }
        public ICellStyle cellStyleDouble { get; set; }
        public ICellStyle cellStyleCurrency { get; set; }
        public ICellStyle cellStyleCurrency4LemonChiffon { get; set; }
        public ICellStyle cellStyleCurrency4CornflowerBlue { get; set; }
        public ICellStyle cellStyleCurrency4LightGreen { get; set; }
        public ICellStyle cellStyleCurrency4Lime { get; set; }
